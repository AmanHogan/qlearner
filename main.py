...
qlearner = QLearningAgent(state_space=env.state_space, action_space=env.action_space, env=env, lr=.01, discount=.998, explore=.1, terminals=[env.goal_state], debug=False, n_eps=1000
                          , n_steps=100, file_path='./qlearner/q_table')
